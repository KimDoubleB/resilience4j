 ...
 *             .build();
 *     MyService myService = Resilience4jHttpExchange.builder(decorators)
 ...
 * example, calling {@link HttpExchangeDecorators.Builder#withFallback(Object)} before {@link
 * HttpExchangeDecorators.Builder#withCircuitBreaker(CircuitBreaker)} would mean that the fallback is
 ...
 * "resilience" strategy.
 */
public class HttpExchangeDecorators implements HttpExchangeDecorator {

    private final List<HttpExchangeDecorator> decorators;

    private HttpExchangeDecorators(List<HttpExchangeDecorator> decorators) {
    ...
    public CheckedFunction<Object[], Object> decorate(CheckedFunction<Object[], Object> fn,
                                                      Method method, HttpExchangeTarget<?> target) {
        CheckedFunction<Object[], Object> decoratedFn = fn;
        for (final HttpExchangeDecorator decorator : decorators) {
    ...
    public static final class Builder {
        ...
        private final List<HttpExchangeDecorator> decorators = new ArrayList<>();
         ...
         *
         * @param fallback must match the HttpExchange interface, i.e. the interface specified when
         *                 calling {@link Resilience4jHttpExchange.Builder#build(Class)}.
         * @return the builder
         */
         ...
         *
         * @param fallbackFactory must return an instance matching the HttpExchange interface.
         * @return the builder
         */
         ...
         * fallback being called when the previous one fails.
         *
         * @param fallback must match the HttpExchange interface.
         ...
         * Resilience4jHttpExchange}.
         *
         * @return the decorators.
         */
        public HttpExchangeDecorators build() {
            return new HttpExchangeDecorators(new ArrayList<>(decorators));
        }
    }
     ...
     */
    private static class TimeLimiterDecorator implements HttpExchangeDecorator {

        private final TimeLimiter timeLimiter;
        private final ScheduledExecutorService executor;

        TimeLimiterDecorator(TimeLimiter timeLimiter, ScheduledExecutorService executor) {
